...
_MSGCONTROLREQ_MSGSEATPARAM = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='main', full_name='MsgControlReq.MsgSeatParam.main', index=0,
      number=1, type=14, cpp_type=8, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='subordinate', full_name='MsgControlReq.MsgSeatParam.subordinate', index=1,
      number=2, type=14, cpp_type=8, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_MSGCONTROLREQ_MSGSEATPARAM.fields_by_name['main'].enum_type = _ENUMSEATLEVEL
_MSGCONTROLREQ_MSGSEATPARAM.fields_by_name['subordinate'].enum_type = _ENUMSEATLEVEL
